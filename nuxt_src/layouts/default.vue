...
## language=yaml
en:
  defaultSiteName: "ScalaMatsuri 2024"
  ...
  head() {
    ...
    return {
      ...
      meta: [
        ...
        { name: "keywords", content: "Scala,スカラ,カンファレンス,ScalaMatsuri,2024" },
        ...
        { name: "application-name", content: "ScalaMatsuri 2024" },
        { name: "apple-mobile-web-app-title", content: "ScalaMatsuri 2024" },
