...
export default defineAppConfig({
  ...
  pages: [
    ...
    { path: 'open-mic-conference', title: { en: 'Open Mic Conference', ja: '飛び入りカンファレンス' }, published: true, header: true, order: 24 },
    { path: 'sponsorship', title: { en: 'Sponsorship(ja)', ja: 'スポンサー募集' }, published: true, header: false, order: 30 },
    ...
    { path: 'travel', title: { en: 'Travel', ja: 'トラベル情報' }, published: true, header: false, order: 91 },
    { path: 'staff', title: { en: 'Staffs', ja: 'スタッフ一覧' }, published: true, header: true, order: 100 },
    { path: 'extra-staff', title: { en: 'Extra Staffs(ja)', ja: '当日スタッフ募集' }, published: true, header: false, order: 101 },
  ],
})
