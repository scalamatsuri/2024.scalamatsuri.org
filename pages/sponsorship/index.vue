...
const plans: Array<Plan> = [
  {
    ...
    color: 'color_shogun',
    price: '¥1,300,000',
    maximum_number_sponsored: '5',
    shoutai_waku: '10名様',
    web_logo_view_html: '◎<br />ファーストビュー',
    web_advertisement: '○',
    distribute_novelty_number: '3点まで',
    logo_panel: 'A会場',
    logo_sousyoku: '◯',
    logo_eco_bag: '◯',
  ...
  },
  {
    ...
    color: 'color_daimyo',
    price: '¥200,000',
    maximum_number_sponsored: '―',
    shoutai_waku: '2名様',
    web_logo_view_html: '○',
    web_advertisement: '○',
    distribute_novelty_number: '2点まで',
    logo_panel: '─',
    logo_sousyoku: '―',
    logo_eco_bag: '―',
    opening_call: 'ロゴ掲載',
  ...
  },
  {
    ...
    web_logo_view_html: '○',
    web_advertisement: '○',
    distribute_novelty_number: '1点まで',
    logo_panel: '─',
    logo_sousyoku: '―',
    logo_eco_bag: '―',
    opening_call: '─',
